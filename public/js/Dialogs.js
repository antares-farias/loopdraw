...
var AboutDialog = function(editorUi)
{
	...
	mxUtils.write(h3, mxResources.get('about') + ' LoopDraw');
	div.appendChild(h3);
	...
	mxUtils.br(div);
	mxUtils.br(div);
	mxUtils.write(div, 'Make Diagram for Loopback Easy');
	mxUtils.br(div);
	mxUtils.write(div, 'Powered by mxGraph ' + mxClient.VERSION);
	mxUtils.br(div);
	var link = document.createElement('a');
	link.setAttribute('href', 'https://www.npmjs.com/package/loopdraw');
